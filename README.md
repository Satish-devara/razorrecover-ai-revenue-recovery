...
> Status: Phase 1 — repository architecture and local-infrastructure scaffold. No application code, AI agent, payment integration, or dashboard exists yet.
...
backend/     Spring Boot API, migrations, and tests (planned)
